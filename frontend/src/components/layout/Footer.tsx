...
const NAV = {
  'Services': [
    { label: 'Architecture Photography', href: '/services' },
    { label: 'Interior Design Photography', href: '/services' },
    { label: 'Hotel & Hospitality Photography', href: '/services' },
    { label: 'Industrial Photography', href: '/services' },
    { label: 'School & Educational Photography', href: '/services' },
    { label: 'Retail & Google Business Photography', href: '/services' },
    { label: 'And More...', href: '/services' },
  ],
  'Photography Academy': [
    { label: 'Workshops', href: '/workshops' },
    { label: 'One-to-One Mentoring', href: '/workshops' },
    { label: 'Corporate Training', href: '/workshops' },
    { label: 'Online Courses', href: '/workshops' },
    { label: 'Student Portfolio', href: '/workshops' },
    { label: 'FAQs', href: '/faq' },
  ],
  'Contact Us': [
