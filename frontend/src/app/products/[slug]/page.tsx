...
export default function ProductDetail() {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 mb-10">
                <button onClick={() => setEnquiryOpen(true)} className="btn-primary" data-hover>
      ...
      <EnquiryPopup open={enquiryOpen} onClose={() => setEnquiryOpen(false)} serviceName={product?.name} />
    </>
  );
}
