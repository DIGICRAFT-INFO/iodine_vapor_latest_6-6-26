...
serviceRouter.get('/fix-slugs', protect, ctrl.fixServiceSlugs);
serviceRouter.get('/:slug', ctrl.getServiceBySlug);
...
enquiryRouter.post('/', upload.single('file'), ctrl.createEnquiry);
