...
const seed = async () => {
  ...
  if (!await Service.countDocuments()) {
    await Service.insertMany([
      ...
      { name: 'Architecture & Interiors', slug: 'architecture', icon: '', order: 3, isActive: true, shortDesc: 'Precision architectural shoots for developers and architects.', features: ['Exteriors', 'Interiors', 'Real Estate'] },
